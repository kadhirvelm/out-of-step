...
import { IStock, IPriceHistory } from "@stochastic-exchange/api";
import _ from "lodash";
import { postgresPool } from "../../../../utils/getPostgresPool";
import { IStockPricerPlugin } from "../../types";

export async function testPriceChange(STOCK_PRICER_PLUGINS: { [name: string]: IStockPricerPlugin }) {
    ...
    // eslint-disable-next-line no-console
    console.log(`INSERT INTO "priceHistory" ("dollarValue", stock, "calculationNotes") VALUES ${allPriceHistoryInserts.join(
        ",",
    )}`);
}
